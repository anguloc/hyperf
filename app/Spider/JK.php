...
/**
 * php bin/hyperf.php process:spider JK
 *
 * 间客
 *
 * @package App\Spider
 */
class JK extends AbstractSpider implements Spider
{
    ...
    protected static $tempDir = BASE_PATH . '/runtime/temp/jk/';
...
//            return $this->doRun();
    ...
    public function doRun()
    {
        ...
        // index.html
//        $resp = $this->client->get("https://www.vbiquge.com/2_2327/");
...
//            $rt[] = [
//                'href' => "https://www.vbiquge.com".$item->children('a')->attr('href'),
//                'title' => $item->text()
//            ];
//        });
