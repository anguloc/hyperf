...
/**
 * php bin/hyperf.php process:spider YJZC
 *
 * 余烬之铳
 *
 * @package App\Spider
 */
class YJZC extends AbstractSpider implements Spider
{
...
//            return $this->doRun();
    ...
    public function doRun()
    {
        ...
        // index.html
//        $resp = $this->client->get("https://www.ibswtan.com/62/62029/");
...
//            $rt[] = [
//                'href' => "https://www.ibswtan.com/62/62029/" . $item->children('a')->attr('href'),
//                'title' => $item->text()
//            ];
//        });
