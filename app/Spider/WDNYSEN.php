...
/**
 * php bin/hyperf.php process:spider WDNYSEN
 *
 * 我的女友是恶女
 *
 * @package App\Spider
 */
class WDNYSEN extends AbstractSpider implements Spider
{
    ...
    protected static $tempDir = BASE_PATH . '/runtime/temp/wdnysen/';
    ...
    public function doRun()
    {
        ...
        // index.html
//        $resp = $this->client->get("https://www.txtbook.net/6_6772/");
...
//            $rt[] = [
//                'href' => "https://www.txtbook.net".$item->children('a')->attr('href'),
//                'title' => $item->text()
//            ];
//        });
...
//
        ...
        $asd = $zxc = 0;
        foreach ($data as $datum) {
//            if (strpos($datum['href'],'20726269') !== false) {
//                $c = false;
//            }
//            if ($c) {
//                continue;
...
//        $this->index();
    ...
    public function spider()
    {
        try {
            ...
            echo 'error url:' . $data['url'], PHP_EOL;
            self::log("error url:{$data['url']}");
//            throw $e;
        }
    }
