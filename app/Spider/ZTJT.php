...
/**
 * php bin/hyperf.php process:spider ZTJT
 *
 * 诸天尽头
 *
 * @package App\Spider
 */
class ZTJT extends AbstractSpider implements Spider
{
    ...
    protected static $tempDir = BASE_PATH . '/runtime/temp/ztjt/';
    ...
    public function doRun()
    {
        ...
        // index.html
//        $resp = $this->client->get("https://www.booktxt.com/17_17908/");
...
//            $rt[] = [
//                'href' => "https://www.booktxt.com".$item->children('a')->attr('href'),
//                'title' => $item->text()
//            ];
//        });
