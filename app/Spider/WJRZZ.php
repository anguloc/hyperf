...
/**
 * php bin/hyperf.php process:spider WJRZZ
 *
 * 我 旧日支配者
 *
 * @package App\Spider
 */
class WJRZZ extends AbstractSpider implements Spider
{
    ...
    protected static $tempDir = BASE_PATH . '/runtime/temp/wjrzz/';
...
//            return $this->doRun();
    ...
    public function doRun()
    {
        ...
        // index.html
//        $resp = $this->client->get("https://www.loveyuedu.com/yuedu/19896/");
...
//            $rt[] = [
//                'href' => "https://www.loveyuedu.com".$item->children('a')->attr('href'),
//                'title' => $item->text()
//            ];
//        });
...
//        return;
        ...
        foreach ($data as $datum) {
            ...
            $c = str_replace(['一秒记住↘.首发↘手机用户输入地址：m.Wanbentxt.coΜ'],'',$c);
            $c = str_replace(['一秒记/住\网址http://m.mu/wu/g.com'],'',$c);
