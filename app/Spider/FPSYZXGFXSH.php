...
/**
 * php bin/hyperf.php process:spider FPSYZXGFXSH
 *
 * 反派少爷只想过佛系生活
 *
 * @package App\Spider
 */
class FPSYZXGFXSH extends AbstractSpider implements Spider
{
    ...
    protected static $tempDir = BASE_PATH . '/runtime/temp/fpsyzxgfxsh/';
...
//            return $this->doRun();
    ...
    public function doRun()
    {
        ...
        // index.html
//        $resp = $this->client->get("https://www.51kanshu.org/book/39098/");
...
//        $encode = mb_detect_encoding($html, array("ASCII", 'UTF-8', "GB2312", "GBK", 'BIG5'));
//        $html = iconv($encode, 'UTF-8//IGNORE', $html);
//        $this->ql->setHtml($html)->find(".listmain dl dd")->each(function (\QL\Dom\Elements $item) use (&$rt) {
//            $rt[] = [
//                'href' => "https://www.51kanshu.org".$item->children('a')->attr('href'),
//                'title' => $item->text()
//            ];
//        });
...
//        $resp = $this->client->get("https://www.vipkanshu.com/shu/32989/10358436.html");
