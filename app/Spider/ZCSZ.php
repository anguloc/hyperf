...
/**
 * php bin/hyperf.php process:spider ZCSZ
 *
 * 战锤神座
 *
 * @package App\Spider
 */
class ZCSZ extends AbstractSpider implements Spider
{
    ...
    protected static $tempDir = BASE_PATH . '/runtime/temp/zcsz/';
...
//            return $this->doRun();
    ...
    public function doRun()
    {
        ...
        // index.html
//        $resp = $this->client->get("https://www.sbooktxt.com/35_35762/");
...
//            $rt[] = [
//                'href' => "https://www.sbooktxt.com".$item->children('a')->attr('href'),
//                'title' => $item->text()
//            ];
//        });
