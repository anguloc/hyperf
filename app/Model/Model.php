 ...
 * @method \Hyperf\Database\Model\Builder|static orWhere($column, $operator = null, $value = null)
 ...
 * @method \Hyperf\Contract\PaginatorInterface simplePaginate($perPage = null, $columns = [], $pageName = 'page', $page = null)  * @method $this|\Hyperf\Database\Model\Model create(array $attributes = [])
 ...
 * @method \Hyperf\Database\Query\Builder getQuery()
 ...
 * @method static \Hyperf\Database\ConnectionInterface getConnection()
